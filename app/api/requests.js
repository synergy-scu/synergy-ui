...
export const invalidRespone = response => response.status === 200 && response.hasOwnProperty('data') && response.data.hasOwnProperty('valid') && response.data.hasOwnProperty('errors') && Array.isArray(response.data.errors) && !response.data.valid;
